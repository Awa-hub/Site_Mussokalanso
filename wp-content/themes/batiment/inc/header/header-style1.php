...
*/
global $rs_option;
$sticky = !empty($rs_option['off_sticky']) ? $rs_option['off_sticky'] : ''; 
    ...
    <div class="header-inner<?php echo esc_attr($sticky_menu);?>">
       ...
       <?php
          if(!empty($rs_option['show-top'])){
           ...
           if($top_bar == ""){?>
             <div class="top-gap">
              <?php require get_parent_theme_file_path('inc/header/top-head/top-head-one.php');
              ?>
            </div>
          <?php
           }
           ...
           if($top_bar == '1'){
              require get_parent_theme_file_path('inc/header/top-head/top-head-one.php');
            } 
          }
        }
      ?>
