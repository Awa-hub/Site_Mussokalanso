...
function wpb_load_widget() {
    register_widget( 'rs_recent_widget' );
}
add_action( 'widgets_init', 'wpb_load_widget' );
 
// Creating the widget 
class rs_recent_widget extends WP_Widget {
...
__('RS Recent Post Widget', 'batiment'), 
 
// Widget description
array( 'description' => __( 'Recent post widget with different options', 'batiment' ), ) 
);
}
...
if ( ! isset( $args['widget_id'] ) ) {
    ...
    $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Recent Posts','batiment' );
...
elseif($show_date){
  ...
  <div class="post-item">
    ...
    <span>
      <?php 
      $post_date_small=get_the_date();
          echo esc_attr($post_date_small);
       ?>
      </span> 
      <span>
      <?php $post_date_one=get_the_date();
...
<p>
  <label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>">
    <?php esc_html_e( 'Number of posts to show:','batiment' ); ?>
  </label>
...
<p>
  ...
  <label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>">
    <?php esc_html_e( 'Display post date?','batiment' ); ?>
  </label>
</p>
<p>
  ...
  <label for="<?php echo esc_attr($this->get_field_id( 'show_featured_image' )); ?>">
    <?php esc_html_e( 'Display featured image?','batiment' ); ?>
  </label>
</p>
<?php
  }
